...
class _ModoVozParaTextoScreenState extends State<ModoVozParaTextoScreen>
  ...
  Future<void> _startListening() async {
    ...
    _whisperListener = () {
      if (whisperService.isListening && whisperService.partialWords.isNotEmpty) {
        if (_textEditorController.textController.text != whisperService.partialWords) {
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: _textEditorController.currentMode?.placeholder ??
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (whisperService.lastWords.isNotEmpty && !whisperService.isListening)
